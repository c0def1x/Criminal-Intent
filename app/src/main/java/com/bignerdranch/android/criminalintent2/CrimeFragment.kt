        ...
        crimeDetailViewModel.crimeLiveData.observe(
            ...
            Observer { crime -> crime?.let{
                ...
                photoUri = FileProvider.getUriForFile(requireActivity(),
                    "com.bignerdranch.android.criminalintent2.fileprovider", photoFile)
                updateUI()
            }
            })
    }
...
// Это пространство оставлено пустым специально
        ...
        dateButton.setOnClickListener {
            DatePickerFragment.newInstance(crime.date as Date).apply {
        ...
        photoButton.apply {
            ...
            setOnClickListener {
                ...
                val cameraActivities:
                        List<ResolveInfo> = packageManager.queryIntentActivities(captureImage,
                    PackageManager.MATCH_DEFAULT_ONLY)
